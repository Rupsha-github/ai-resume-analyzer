    ...
    useEffect(() => {
        ...
        loadResume()
            ...
            .catch(error => {
                ...
                alert("Something went wrong while loading your resume.");
            });
    }, [id]);
    ...
    return (
        <main className="!pt-0">
            ...
            <div className="flex flex-row w-full max-lg:flex-col-reverse">
                ...
                <section className="feedback-section px-6 py-10">
                    ...
                    {feedback ? (
                        ...
                        <div className="flex justify-center items-center">
                            <img src="/images/resume-scan-2.gif" alt="Scanning..." className="w-full max-w-md" />
                        </div>
                    )}
                </section>
            </div>
